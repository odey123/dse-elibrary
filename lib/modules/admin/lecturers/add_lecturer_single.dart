...
class AddLecturerSingle extends ConsumerStatefulWidget {
  const AddLecturerSingle({super.key});

  @override
  ConsumerState<AddLecturerSingle> createState() => _AddLecturerSingleState();
}

class _AddLecturerSingleState extends ConsumerState<AddLecturerSingle> {
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              YBox(kMacroPadding),
                              CustomTextInputField(
                                label: lecturerEmailAddress,
                                hintText: enterLecturerEmailAddress,
                                controller: _email,
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (firstName.isEmpty ||
                                        ...
                                        try {
                                          ...
                                          log('$currentUser');
                                          await _function.onboardLecturer(
                                            firstName: firstName,
                                            lastName: lastName,
                                            email: email,
                                            gender: gender,
                                          ...
                                          if (mounted) {
                                            ...
                                            if (e
                                              ...
                                              showErrorDialog(
                                                context: mainContext,
                                                text:
                                                    'You do not have permission to onboard lecturers.',
                                              );
                                            } else if (e
                                              ...
                                              showErrorDialog(
                                                context: mainContext,
                                                text:
                                                    'Lecturer has already been onboarded.',
                                              );
                                            } else if (e
