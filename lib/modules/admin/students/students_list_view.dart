  ...
  Widget _buildStudentRow(Student student) {
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildDataColumn('${student.firstName} ${student.lastName}'),
          _buildDataColumn(student.level),
          _buildDataColumn(student.email),
          _buildDataColumn(student.gender),
        ],
      ),
    );
  }
