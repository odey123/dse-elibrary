...
class AddStudentSingle extends ConsumerStatefulWidget {
  const AddStudentSingle({super.key});

  @override
  ConsumerState<AddStudentSingle> createState() => _AddStudentSingleState();
}

class _AddStudentSingleState extends ConsumerState<AddStudentSingle> {
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              YBox(kMacroPadding),
                              CustomTextInputField(
                                label: studentEmailAddress,
                                hintText: enterStudentEmailAddress,
                                controller: _email,
                                ...
                                children: [
                                  CustomTextButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      final level = _currentLevel.text;
                                      ...
                                      if (firstName.isEmpty ||
                                        ...
                                        try {
                                          ...
                                          await _function.onboardStudent(
                                            firstName: firstName,
                                            lastName: lastName,
                                            email: email,
                                            gender: gender,
                                          ...
                                          if (mounted) {
                                            ...
                                            if (e
                                              ...
                                              showErrorDialog(
                                                context: mainContext,
                                                text:
                                                    'You do not have permission to onboard students.',
                                              );
                                            } else if (e
                                              ...
                                              showErrorDialog(
                                                context: mainContext,
                                                text:
                                                    'Student has already been onboarded.',
                                              );
                                            } else if (e
